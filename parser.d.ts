...
export type StartRuleNames = "Filter"
export interface ParseOptions<T extends StartRuleNames = "Filter"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Filter">>(
  input: string,
  options?: Options,
): any
